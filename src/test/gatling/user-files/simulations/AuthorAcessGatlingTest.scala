...
/**
 * Performance test for the AuthorAcess entity.
 */
class AuthorAcessGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AuthorAcess entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all authorAcesses")
            .get("/api/author-acesses")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
